...
import com.bandmate.ui.Blogs;
import com.bandmate.ui.LeftNavAdapter;
import com.bandmate.ui.Player;
import com.bandmate.ui.Profile;
import com.bandmate.ui.Updates;
...
public class MainActivity extends CustomActivity
{
	...
	/** The adapter for left navigation list. */
	...
	private ArrayList<Data> getDummyLeftNavItems()
	{
		...
		al.add(new Data("My Profile", R.drawable.ic_nav1,
				R.drawable.ic_nav1_sel));
		al.add(new Data("Artist Updates", R.drawable.ic_nav2,
				R.drawable.ic_nav2_sel));
		al.add(new Data("Music Player", R.drawable.ic_nav3,
				R.drawable.ic_nav3_sel));
		al.add(new Data("Blogs", R.drawable.ic_nav4, R.drawable.ic_nav4_sel));
		return al;
	}
	...
	/* (non-Javadoc)
	 * @see com.bandmate.custom.CustomActivity#onClick(android.view.View)
	 */
	@Override
